...
describe("groupAndSortRegistrations", () => {
  it("groups by sku and sorts groups by latest timestamp desc, and items desc", () => {
    const regs: Registration[] = [
      { id: "1", orderNumber: "ON-1", sku: "A", customerName: "c1", whatsapp: "1", variation: "v1", timestamp: makeDate(5), status: "pending" },
      { id: "2", orderNumber: "ON-2", sku: "A", customerName: "c2", whatsapp: "2", variation: "v2", timestamp: makeDate(15), status: "pending" },
      { id: "3", orderNumber: "ON-3", sku: "B", customerName: "c3", whatsapp: "3", variation: "v3", timestamp: makeDate(2), status: "completed" },
      { id: "4", orderNumber: "ON-4", sku: "C", customerName: "c4", whatsapp: "4", variation: "v4", timestamp: makeDate(30), status: "pending" },
    ];
  ...
  it("applies view filter: pending only", () => {
    const regs: Registration[] = [
      { id: "1", orderNumber: "ON-1", sku: "A", customerName: "c1", whatsapp: "1", variation: "v1", timestamp: makeDate(5), status: "pending" },
      { id: "2", orderNumber: "ON-2", sku: "B", customerName: "c2", whatsapp: "2", variation: "v2", timestamp: makeDate(2), status: "completed" },
    ];
  ...
  it("applies sku search filter (partial, case-insensitive)", () => {
    const regs: Registration[] = [
      { id: "1", orderNumber: "ON-AAA", sku: "R2026-AAA", customerName: "c1", whatsapp: "1", variation: "v1", timestamp: makeDate(5), status: "pending" },
      { id: "2", orderNumber: "ON-BBB", sku: "R2026-BBB", customerName: "c2", whatsapp: "2", variation: "v2", timestamp: makeDate(2), status: "pending" },
    ];
